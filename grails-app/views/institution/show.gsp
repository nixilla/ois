            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="institution.website.label" default="Website" /></td>
                            
                            <td valign="top" class="value"><a href="${fieldValue(bean: institutionInstance, field: "website")}" target="_blank">${fieldValue(bean: institutionInstance, field: "website")}</a></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="institution.programme.label" default="Programmes" /></td>
