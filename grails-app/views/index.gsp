<html>
  ...
  <body>
    <div class="leftColumn">
      ...
      <p>This is system is also the CBSD coursework project of two students: Janusz Slota and Nima Fatemi. We're hoping the get very good marks :-)</p>
      <h2>How to use it?</h2>
